...
- Full semantic decision table: one row for every candidate the agent investigated, including final decision, theme, semantic judgment, language quality, trust rationale, and next step.
